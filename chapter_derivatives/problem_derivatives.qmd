...
<!-- # Solution: 1.5%: $y = 2.7\% - 4 \cdot \ln(3009/3000)$ -->
...
<!-- # Solution: $9.29\%$: $y = 2.6\% - 6 \ln(35.7/36.1)$ -->
...
<!-- # Solution: $16.91$: $\max(125 - 100, 0) - 7.89 e^{0.05 \cdot 6/12}$ and $-8.09$ -->
...
<!-- # Solution: Put-call parity: $r = 1.55\%$ -->
...
# a. Cash = $-114.5$ (borrow), Shares = $0.69$

# b. Current stock price is $153.0$ and it can go to $168.3$ or $137.7$. Hence, the payoff of the option will be $0$ in both following states. The value of the option at Year 1 is $0$.
