...
\begin{center}
\large{\textbf{\sc{Problem Set 2 - Solution}}}
\vspace{1.0cm}
\end{center}
...
\noindent 3. Suppose you want to hedge your exposure to the British pound by using a money market hedge. You have £100,000 receivable in six months and the current spot rate is \$1.40/£. The annual interest rate in the US is 2\% and in the UK is 3\%. Follow the the steps below. Use ACT/365.
...
%Amount repaid = £100,000 x \$1.40/£ = \$140,000\\
%Amount hedged = \$139,250.425 - \$140,000 = -\$749.575  \\
